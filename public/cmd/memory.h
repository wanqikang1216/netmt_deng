...
#else
#define XMALLOC(mtype, size)       zebramalloc ((mtype), (size))
#define XCALLOC(mtype, size)       zebracalloc ((mtype), (size))
#define XREALLOC(mtype, ptr, size) zebrarealloc ((mtype), (ptr), (size))
#define XFREE(mtype, ptr)          zebrafree ((mtype), (ptr))
#define XSTRDUP(mtype, str)        zebrastrdup ((mtype), (str))
#endif /* MEMORY_LOG */

/* Prototypes of memory function. */
void *zebramalloc (int type, size_t size);
void *zebracalloc (int type, size_t size);
void *zebrarealloc (int type, void *ptr, size_t size);
void  zebrafree (int type, void *ptr);
char *zebrastrdup (int type, char *str);
