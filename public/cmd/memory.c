...
/* Memory allocation. */
void *
zebramalloc (int type, size_t size)
{
  void *memory;
...
void *
zebracalloc (int type, size_t size)
{
  void *memory;
...
/* Memory reallocation. */
void *
zebrarealloc (int type, void *ptr, size_t size)
{
  void *memory;
...
mtype_zrealloc (const char *file, int line, int type, void *ptr, size_t size)
{
  ...
  memory = zebrarealloc (type, ptr, size);
